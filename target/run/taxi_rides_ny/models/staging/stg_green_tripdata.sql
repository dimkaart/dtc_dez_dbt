  ...
  create or replace view `warm-ring-374916`.`dbt_dimkaart`.`stg_green_tripdata`
  OPTIONS()
...
(
  ...
  from `warm-ring-374916`.`dbt_dimkaart`.`rides_green`  -- macro for FROM clause in schema.yml
